...
- `esios.api` contains framework-independent endpoint clients.
- `esios.mcp` contains FastMCP tools, validation, error responses, and
...
- `esios_glossary_search`: search the complete localized glossary and return
  the shared structured glossary response.
