...
The `demanda-tiempo-real` widget is national-only. REE does not expose
autonomous-community real-time curves through this REData endpoint; those
curves are provided by REE's separate Visiona service.
